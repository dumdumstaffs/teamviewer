...
export function Create() {
    ...
    const { register, handleSubmit, formState: { errors, isSubmitting } } = useForm<z.infer<typeof createSchema>>({
    ...
    return (
        <form onSubmit={create} className="mx-auto border border-gray-200 dark:border-zinc-800 rounded-md w-full max-w-lg p-4 pb-8">
            <div className="flex flex-col items-center space-y-3 p-2">
                <h3 className="text-2xl font-medium">Create</h3>
            </div>
            ...
            <Button loading={isSubmitting || createUserMutation.isLoading} className="w-full py-2 mt-4 rounded-md border border-blue-600 bg-blue-600 text-sm text-white font-medium">
                Create
            </Button>
        </form>
    )
